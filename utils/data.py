...
class iImageNetA(iData):
    ...
    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        train_dir = "/data/sunhl/data/imagenet-a/train"
        test_dir = "/data/sunhl/data/imagenet-a/test"
...
class omnibenchmark(iData):
    ...
    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        train_dir = "/data/sunhl/data/omnibenchmark/train/"
        test_dir = "/data/sunhl/data/omnibenchmark/test/"
...
class vtab(iData):
    ...
    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        train_dir = "/data/sunhl/data/vtab/train/"
        test_dir = "/data/sunhl/data/vtab/test/"
